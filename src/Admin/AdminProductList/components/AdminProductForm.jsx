...
import { deleteProductAsync, fetchProductDetailAsync, selectDetails, updateProductByIdAsync } from '../../../features/Product/ProductSlice'
...
export default function AdminProductForm() {
    ...
    const handleUpdateProduct = (data) => {
        if (productId !== 'addNew') {
            ...
            delete newData.image4;
            delete newData.image5;
            dispatch(AddProductAsync(newData))
        }
    }
