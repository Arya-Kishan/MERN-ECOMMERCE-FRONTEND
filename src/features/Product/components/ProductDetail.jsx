...
import { PlusIcon, StarIcon, UserCircleIcon } from '@heroicons/react/20/solid'
                        ...
                        <div className="mx-auto max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
                            ...
                            <div className="py-10 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pb-16 lg:pr-8 lg:pt-6">
                                ...
                                <div className='flex items-center justify-between'>
                                    ...
                                    <p onClick={() => setWriteReview(true)} className='text-2xl cursor-pointer'><PlusIcon className='h-8 w-8' /></p>
                                </div>
                                    ...
                                    {reviews.map((e) => (
                                        <div className='mt-8 flex flex-col gap-4' key={e._id}>
                                            <div className='flex justify-between'>
                                                <h3 className="flex items-center gap-1"><UserCircleIcon className='w-5 h-5' />{e.reviewUser}</h3>
