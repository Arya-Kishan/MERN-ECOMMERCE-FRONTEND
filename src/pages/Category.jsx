...
import { setProductsArrayToNull } from '../features/Product/ProductSlice'
    ...
    return (
        <div className='w-full'>
            <div className='grid grid-cols-2 md:grid-cols-4 place-items-center gap-5 bg-gray-100 p-5'>
                ...
                <div onClick={() => {
                    dispatch(setProductsArrayToNull())
                    navigate("/infiniteScroll/laptops")
                }}
                    className='flex items-center justify-center gap-10 p-2 cursor-pointer bg-white'>
                ...
                <div onClick={() => {
                    dispatch(setProductsArrayToNull())
                    navigate("/infiniteScroll/smartphones")
                }}
                    className='flex items-center justify-center gap-10 p-2 cursor-pointer bg-white'>
                ...
                <div onClick={() => {
                    dispatch(setProductsArrayToNull())
                    navigate("/infiniteScroll/sunglasses")
                }}
                    className='flex items-center justify-center gap-10 p-2 cursor-pointer bg-white'>
                ...
                <div onClick={() => {
                    dispatch(setProductsArrayToNull())
                    navigate("/infiniteScroll/lighting")
                }}
                    className='flex items-center justify-center gap-10 p-2 cursor-pointer bg-white'>
                ...
                <div onClick={() => {
                    dispatch(setProductsArrayToNull())
                    navigate("/infiniteScroll/furniture")
                }}
                    className='flex items-center justify-center gap-10 p-2 cursor-pointer bg-white'>
                ...
                <div onClick={() => {
                    dispatch(setProductsArrayToNull())
                    navigate("/infiniteScroll/mens-shoes")
                }}
                    className='flex items-center justify-center gap-10 p-2 cursor-pointer bg-white'>
                ...
                <div onClick={() => {
                    dispatch(setProductsArrayToNull())
                    navigate("/infiniteScroll/mens-watches")
                }}
                    className='flex items-center justify-center gap-10 p-2 cursor-pointer bg-white'>
                ...
                <div onClick={() => {
                    dispatch(setProductsArrayToNull())
                    navigate("/infiniteScroll/womens-dresses")
                }}
                    className='flex items-center justify-center gap-10 p-2 cursor-pointer bg-white'>
